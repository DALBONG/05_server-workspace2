--CREATE USER SERVER IDENTIFIED BY SERVER; -- 관리자계정
...
INSERT INTO MEMBER 
VALUES (SEQ_UNO.NEXTVAL, 'user01', 'pass01', '차은우', '010-3333-4444', 'user01@kh.or.kr', '서울시 양천구 목동', NULL, SYSDATE, SYSDATE, DEFAULT);

INSERT INTO MEMBER 
VALUES (SEQ_UNO.NEXTVAL, 'user02', 'pass02', '주지훈', '010-7444-1234', 'user02@kh.or.kr', '서울시 강서구', NULL, SYSDATE, SYSDATE, DEFAULT);
