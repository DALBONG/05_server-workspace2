...
public class JqAjaxController4 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list.add(new Member(1, "차훈호", 20, "남"));
		list.add(new Member(2, "장은영", 25, "여"));
		list.add(new Member(3, "박휴쉰", 32, "남"));
		list.add(new Member(4, "이진송", 36, "남"));
		
		// jsonObject가 n개. 이때 쓰는게 JSONArray
